    ...
    local ret = {
      ...
      setup = {
        ...
        csharp_ls = function(_, opts)
          -- Example: add extra settings or modify opts before setup
          opts.enable_editorconfig_support = true
          opts.enable_ms_build_load_projects_on_demand = true
          ...
          return false -- return false to let default lspconfig setup run
        end,
      },
    }
    return ret
